...
-- Library init
    ...
    local fonts = {}; do
        function Register_Font(Name, Weight, Style, Asset)
            local newName   = library.directory.."/Fonts/"..Name
            local assetName = library.directory.."/Fonts/"..Asset.Id

            if not isfile(assetName) then
                writefile(assetName, Asset.Font)
            end

            if isfile(newName .. ".font") then
                delfile(newName .. ".font")
            end
            ...
            writefile(newName .. ".font", http_service:JSONEncode(Data))

            return getcustomasset(newName .. ".font");
        end
        
        local Medium = Register_Font("Medium", 200, "Normal", {
            Id = "Medium.ttf",
            Font = game:HttpGet("https://github.com/computerintrusion/MercenaryX/raw/refs/heads/main/Utilities/Fonts/Inter28ptMedium.ttf"),
        })

        local SemiBold = Register_Font("SemiBold", 200, "Normal", {
            Id = "SemiBold.ttf",
            Font = game:HttpGet("https://github.com/computerintrusion/MercenaryX/raw/refs/heads/main/Utilities/Fonts/Inter28ptSemiBold.ttf"),
        })
...
-- Library functions 
    ...
    -- Library element functions
        function library:window(properties)
            local cfg = { 
                suffix = properties.suffix or properties.Suffix or "X";
                name = properties.name or properties.Name or "Mercenary";
                version = properties.version or properties.Version or "v1.00";
                game_name = properties.gameInfo or properties.game_info or properties.GameInfo or "unknown";
